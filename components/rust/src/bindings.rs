    ...
    pub mod component {
        pub mod rust {
            ...
            pub mod ih {
                ...
                macro_rules! __export_component_rust_ih_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "component:rust/ih#hello-world"]
          unsafe extern "C" fn export_hello_world() -> *mut u8 {
            $($path_to_types)*::_export_hello_world_cabi::<$ty>()
          }
          #[export_name = "cabi_post_component:rust/ih#hello-world"]
          unsafe extern "C" fn _post_return_hello_world(arg0: *mut u8,) {
            $($path_to_types)*::__post_return_hello_world::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_rust_ih_cabi;
                #[repr(align(4))]
...
macro_rules! __export_hello_impl {
  ...
  $($path_to_types_root)*::exports::component::rust::ih::__export_component_rust_ih_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::rust::ih);
  )
}
#[doc(inline)]
...
B\x02\x01@\0\0s\x04\0\x0bhello-world\x01\0\x04\x01\x11component:rust/ih\x05\0\x04\
\x01\x14component:rust/hello\x04\0\x0b\x0b\x01\0\x05hello\x03\0\0\0G\x09producer\
